...
export default function Navbar_Pacient() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [activePage, setActivePage] = useState("consultas"); // ⭐ PAGE ACTIVA

  return (
    <header className="fixed w-full z-20 top-0 start-0">
      <nav className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-900">
      ...
      <nav className="bg-gradient-to-r from-blue-800 via-blue-900 to-black border-y border-white/10 hidden md:block">
        <div className="max-w-screen-xl mx-auto px-4 py-3">
          <ul className="flex space-x-10 text-sm font-medium text-white">
            
            <li>
              <Link            
                  href="/Pacients/consult"
